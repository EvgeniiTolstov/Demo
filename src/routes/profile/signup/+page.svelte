      ...
      <div class="relative flex flex-wrap bg-white">
        <div class="w-full md:w-4/6 px-4">
          <div class="lg:max-w-3xl mx-auto py-20 px-4 md:px-10 lg:px-20">
            ...
            <h3 class="mb-8 text-4xl md:text-5xl font-bold font-heading">{$Username}
  </h3>
            
            <form class="flex flex-wrap -mx-4" action="">
              <div class="w-full md:w-1/2 px-4 mb-8 md:mb-12">
                <label for="">
                  <h4 class="mb-5 text-gray-400 uppercase font-bold font-heading">ФИО</h4>
        <input class="p-5 w-full border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md" type="text" bind:value={fio} >
                </label>
              </div>
              <div class="w-full md:w-1/2 px-4 mb-12">
                <label for="">
                  <h4 class="mb-5 text-gray-400 uppercase font-bold font-heading">ИНН</h4>
                  <input bind:value={inn} class="p-5 w-full border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md" type="text">
                </label>
              </div>
              <div class="w-full md:w-1/2 px-4 mb-8 md:mb-12">
                <label for="">
                  <h4 class="mb-5 text-gray-400 uppercase font-bold font-heading">E-MAIL</h4>
        <input class="p-5 w-full border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md" type="email" bind:value={email} >
              ...
              <div class="w-full md:w-1/2 px-4 mb-12">
                <label for="">
                  <h4 class="mb-5 text-gray-400 uppercase font-bold font-heading">Телефон</h4>
                  <input bind:value={phone} class="p-5 w-full border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md" type="text">
                </label>
              </div>
              ...
              <div class="w-full px-4">
                <button on:click={login} class="bg-blue-800 hover:bg-blue-900 text-white font-bold font-heading py-5 px-8 rounded-md uppercase" >Сохранить</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div class="relative container px-4 mx-auto">
        ...
        <div class="relative flex flex-wrap bg-white">
          <div class="w-full md:w-4/6 px-4">
            <div class="lg:max-w-3xl mx-auto py-20 px-4 md:px-10 lg:px-20">
              <a class="inline-block mb-14 text-3xl font-bold font-heading" href="#"><img src="/images/yofte-logo.svg" alt="" width="100"></a>
              <h3 class="mb-8 text-4xl md:text-5xl font-bold font-heading">Регистрация
    </h3>
              ...
              <form class="flex flex-wrap -mx-4"  method="POST">
                <div class="w-full md:w-1/2 px-4 mb-8 md:mb-12">
                  <label>
                   ...
                   <input name="email" class="p-5 w-full border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md" type="email"  >
                  </label>
                </div>
                ...
                <div class="w-full px-4 mb-12" >
                    <div class="w-full md:w-1/2 px-4 mb-12">
                        <label >
                          ...
                          <p class="text-xs">Пароль должен содержать не менее шести символов, включая как минимум 1 букву и 1 цифру. </p>
                          {#if (checkpassword5)}
                          <p class="mb-2  px-4 text-xs bg-green-800">  Пароль удовлетворяет требованиям </p>
                          {:else}
                          <p class=" mb-2 px-4 text-xs bg-red-800">   Пароль не удовлетворяет требованиям </p>
                          
                          {/if}
                          <input name="password" class="p-5 w-full border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md" { type } { value } {...$$restProps} on:input={ onInput }>
                          <button type="button" on:click="{ () => show_password = !show_password }">{show_password ? 'Показать' : 'Скрыть'}</button>
                        </label>
                      </div>
                  
                </div>
                <div class="w-full px-4">
                  <button class="bg-blue-800 hover:bg-blue-900 text-white font-bold font-heading py-5 px-8 rounded-md uppercase" >Зарегистрировать</button>
                </div>
              </form>
            </div>
          </div>
          <div class="w-full md:w-2/6 h-128 md:h-auto flex items-center lg:items-end px-4 pb-20 bg-cover bg-no-repeat" style="background-image: url('/images/baner2.png');">
            <div>
              ...
              <div class="inline-flex items-center px-6 py-3 bg-white rounded-full">
                ...
                <a href="/profile/support">Обратиться в службу поддержки
                </a>
              </div>
            </div>
          </div>
