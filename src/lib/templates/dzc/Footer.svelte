  ...
  <section class="py-20 bg-blue-300">
    <div class="container mx-auto px-4">
      ...
      <div class="pt-14 flex items-center justify-center">
        <a class="inline-block mr-4 text-white text-2xl font-bold font-heading" href="/dzc/"><img src="/images/logohead.png" alt="" width="100"></a>
        <p class="inline-block text-sm text-gray-200">© Copyright 2023</p>
      </div>
    </div>
  </section>
    ...
    <div class="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50">
      ...
      <nav class="relative flex flex-col py-6 px-6 w-full h-full bg-white border-r overflow-y-auto">
        ...
        <ul class="text-3xl font-bold font-heading">
          <li class="mb-8"><a href="#">Категории</a></li>
