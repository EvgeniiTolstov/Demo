...
<div class="header">
	...
	<div class="header-menu">
		<a class="menu-link is-active" href="/collection">Сollections</a>
		<a class="menu-link notify" href="/collection/add">Add table</a>
		<a class="menu-link" href="/collection/test">New</a>
